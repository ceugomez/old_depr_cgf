...
#ifndef PX4__MSG__DETAIL__ESTIMATOR_EVENT_FLAGS__STRUCT_H_
#define PX4__MSG__DETAIL__ESTIMATOR_EVENT_FLAGS__STRUCT_H_
...
// Struct defined in msg/EstimatorEventFlags in the package px4.
typedef struct px4__msg__EstimatorEventFlags
{
  uint64_t timestamp;
...
// Struct for a sequence of px4__msg__EstimatorEventFlags.
typedef struct px4__msg__EstimatorEventFlags__Sequence
{
...
#endif  // PX4__MSG__DETAIL__ESTIMATOR_EVENT_FLAGS__STRUCT_H_
