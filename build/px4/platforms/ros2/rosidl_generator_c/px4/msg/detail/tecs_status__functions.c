...
bool
px4__msg__TecsStatus__init(px4__msg__TecsStatus * msg)
{
  if (!msg) {
    return false;
  }
...
void
px4__msg__TecsStatus__fini(px4__msg__TecsStatus * msg)
{
  if (!msg) {
    return;
  }
...
bool
px4__msg__TecsStatus__are_equal(const px4__msg__TecsStatus * lhs, const px4__msg__TecsStatus * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4__msg__TecsStatus__copy(
  const px4__msg__TecsStatus * input,
  px4__msg__TecsStatus * output)
{
  if (!input || !output) {
    return false;
  }
...
px4__msg__TecsStatus *
px4__msg__TecsStatus__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TecsStatus * msg = (px4__msg__TecsStatus *)allocator.allocate(sizeof(px4__msg__TecsStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__TecsStatus));
  bool success = px4__msg__TecsStatus__init(msg);
  if (!success) {
...
void
px4__msg__TecsStatus__destroy(px4__msg__TecsStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__TecsStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
px4__msg__TecsStatus__Sequence__init(px4__msg__TecsStatus__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TecsStatus * data = NULL;

  if (size) {
    data = (px4__msg__TecsStatus *)allocator.zero_allocate(size, sizeof(px4__msg__TecsStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__TecsStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__TecsStatus__fini(&data[i - 1]);
      }
...
void
px4__msg__TecsStatus__Sequence__fini(px4__msg__TecsStatus__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__TecsStatus__fini(&array->data[i]);
    }
...
px4__msg__TecsStatus__Sequence *
px4__msg__TecsStatus__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__TecsStatus__Sequence * array = (px4__msg__TecsStatus__Sequence *)allocator.allocate(sizeof(px4__msg__TecsStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__TecsStatus__Sequence__init(array, size);
  if (!success) {
...
void
px4__msg__TecsStatus__Sequence__destroy(px4__msg__TecsStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__TecsStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4__msg__TecsStatus__Sequence__are_equal(const px4__msg__TecsStatus__Sequence * lhs, const px4__msg__TecsStatus__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__TecsStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4__msg__TecsStatus__Sequence__copy(
  const px4__msg__TecsStatus__Sequence * input,
  px4__msg__TecsStatus__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__TecsStatus);
    px4__msg__TecsStatus * data =
      (px4__msg__TecsStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__TecsStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4__msg__TecsStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
