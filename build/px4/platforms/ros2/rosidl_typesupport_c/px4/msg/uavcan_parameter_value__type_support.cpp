...
static const _UavcanParameterValue_type_support_symbol_names_t _UavcanParameterValue_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, UavcanParameterValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, UavcanParameterValue)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, UavcanParameterValue)() {
  return &::px4::msg::rosidl_typesupport_c::UavcanParameterValue_message_type_support_handle;
}
