...
static const _SensorAccelFifo_type_support_symbol_names_t _SensorAccelFifo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, SensorAccelFifo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, SensorAccelFifo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, SensorAccelFifo)() {
  return &::px4::msg::rosidl_typesupport_c::SensorAccelFifo_message_type_support_handle;
}
