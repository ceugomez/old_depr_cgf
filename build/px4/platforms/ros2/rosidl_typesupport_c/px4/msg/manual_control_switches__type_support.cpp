...
static const _ManualControlSwitches_type_support_symbol_names_t _ManualControlSwitches_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, ManualControlSwitches)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, ManualControlSwitches)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, ManualControlSwitches)() {
  return &::px4::msg::rosidl_typesupport_c::ManualControlSwitches_message_type_support_handle;
}
