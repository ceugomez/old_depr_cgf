...
static const _VehicleAngularAccelerationSetpoint_type_support_symbol_names_t _VehicleAngularAccelerationSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, VehicleAngularAccelerationSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleAngularAccelerationSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, VehicleAngularAccelerationSetpoint)() {
  return &::px4::msg::rosidl_typesupport_c::VehicleAngularAccelerationSetpoint_message_type_support_handle;
}
