...
static const _VehicleMagnetometer_type_support_symbol_names_t _VehicleMagnetometer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, VehicleMagnetometer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleMagnetometer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, VehicleMagnetometer)() {
  return &::px4::msg::rosidl_typesupport_c::VehicleMagnetometer_message_type_support_handle;
}
