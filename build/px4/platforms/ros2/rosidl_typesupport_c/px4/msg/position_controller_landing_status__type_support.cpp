...
static const _PositionControllerLandingStatus_type_support_symbol_names_t _PositionControllerLandingStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, PositionControllerLandingStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, PositionControllerLandingStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, PositionControllerLandingStatus)() {
  return &::px4::msg::rosidl_typesupport_c::PositionControllerLandingStatus_message_type_support_handle;
}
