...
static const _EstimatorInnovations_type_support_symbol_names_t _EstimatorInnovations_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, EstimatorInnovations)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, EstimatorInnovations)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, EstimatorInnovations)() {
  return &::px4::msg::rosidl_typesupport_c::EstimatorInnovations_message_type_support_handle;
}
