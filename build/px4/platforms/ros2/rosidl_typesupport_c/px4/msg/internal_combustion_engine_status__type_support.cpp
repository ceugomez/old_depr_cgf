...
static const _InternalCombustionEngineStatus_type_support_symbol_names_t _InternalCombustionEngineStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, InternalCombustionEngineStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, InternalCombustionEngineStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, InternalCombustionEngineStatus)() {
  return &::px4::msg::rosidl_typesupport_c::InternalCombustionEngineStatus_message_type_support_handle;
}
