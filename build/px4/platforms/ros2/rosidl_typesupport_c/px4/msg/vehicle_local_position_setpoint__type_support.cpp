...
static const _VehicleLocalPositionSetpoint_type_support_symbol_names_t _VehicleLocalPositionSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, VehicleLocalPositionSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleLocalPositionSetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, VehicleLocalPositionSetpoint)() {
  return &::px4::msg::rosidl_typesupport_c::VehicleLocalPositionSetpoint_message_type_support_handle;
}
