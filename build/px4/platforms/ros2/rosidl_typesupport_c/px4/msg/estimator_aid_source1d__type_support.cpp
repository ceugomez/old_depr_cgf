...
static const _EstimatorAidSource1d_type_support_symbol_names_t _EstimatorAidSource1d_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, EstimatorAidSource1d)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, EstimatorAidSource1d)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, EstimatorAidSource1d)() {
  return &::px4::msg::rosidl_typesupport_c::EstimatorAidSource1d_message_type_support_handle;
}
