...
#ifndef PX4__MSG__DETAIL__QSHELL_REQ__STRUCT_HPP_
#define PX4__MSG__DETAIL__QSHELL_REQ__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__QshellReq __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__QshellReq __declspec(deprecated)
#endif
...
struct QshellReq_
{
  ...
  // pointer types
  using RawPtr =
    px4::msg::QshellReq_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::QshellReq_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::QshellReq_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::QshellReq_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::QshellReq_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::QshellReq_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::QshellReq_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::QshellReq_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::QshellReq_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__QshellReq
    std::shared_ptr<px4::msg::QshellReq_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__QshellReq
    std::shared_ptr<px4::msg::QshellReq_<ContainerAllocator> const>
...
using QshellReq =
  px4::msg::QshellReq_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__QSHELL_REQ__STRUCT_HPP_
