...
#ifndef PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_WAYPOINT__STRUCT_HPP_
#define PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_WAYPOINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__VehicleTrajectoryWaypoint __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__VehicleTrajectoryWaypoint __declspec(deprecated)
#endif
...
struct VehicleTrajectoryWaypoint_
{
  ...
  explicit VehicleTrajectoryWaypoint_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->timestamp = 0ull;
      this->type = 0;
      this->waypoints.fill(px4::msg::TrajectoryWaypoint_<ContainerAllocator>{_init});
    }
  }
  ...
  : waypoints(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->timestamp = 0ull;
      this->type = 0;
      this->waypoints.fill(px4::msg::TrajectoryWaypoint_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _waypoints_type =
    std::array<px4::msg::TrajectoryWaypoint_<ContainerAllocator>, 5>;
  ...
  Type & set__waypoints(
    const std::array<px4::msg::TrajectoryWaypoint_<ContainerAllocator>, 5> & _arg)
  {
    this->waypoints = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__VehicleTrajectoryWaypoint
    std::shared_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__VehicleTrajectoryWaypoint
    std::shared_ptr<px4::msg::VehicleTrajectoryWaypoint_<ContainerAllocator> const>
...
using VehicleTrajectoryWaypoint =
  px4::msg::VehicleTrajectoryWaypoint_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_WAYPOINT__STRUCT_HPP_
