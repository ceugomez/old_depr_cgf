...
{
public:
  explicit Init_IridiumsbdStatus_last_heartbeat(::px4::msg::IridiumsbdStatus & msg)
  : msg_(msg)
  {}
  Init_IridiumsbdStatus_tx_buf_write_index last_heartbeat(::px4::msg::IridiumsbdStatus::_last_heartbeat_type arg)
  {
...
public:
  ...
  {}
  Init_IridiumsbdStatus_last_heartbeat timestamp(::px4::msg::IridiumsbdStatus::_timestamp_type arg)
  {
