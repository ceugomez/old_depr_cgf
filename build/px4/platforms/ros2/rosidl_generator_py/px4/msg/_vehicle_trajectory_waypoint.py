    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.VehicleTrajectoryWaypoint')
            logger.debug(
            ...
            from px4.msg import TrajectoryWaypoint
...
class VehicleTrajectoryWaypoint(metaclass=Metaclass_VehicleTrajectoryWaypoint):
    ...
    _fields_and_field_types = {
        'timestamp': 'uint64',
        'type': 'uint8',
        'waypoints': 'px4/TrajectoryWaypoint[5]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint64'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['px4', 'msg'], 'TrajectoryWaypoint'), 5),  # noqa: E501
    )
