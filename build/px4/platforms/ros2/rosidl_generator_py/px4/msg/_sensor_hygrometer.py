...
class Metaclass_SensorHygrometer(type):
    """Metaclass of message 'SensorHygrometer'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.SensorHygrometer')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sensor_hygrometer
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sensor_hygrometer
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sensor_hygrometer
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sensor_hygrometer
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sensor_hygrometer
...
class SensorHygrometer(metaclass=Metaclass_SensorHygrometer):
    """Message class 'SensorHygrometer'."""
