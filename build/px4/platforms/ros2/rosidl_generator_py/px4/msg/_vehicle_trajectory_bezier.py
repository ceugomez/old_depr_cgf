    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.VehicleTrajectoryBezier')
            logger.debug(
            ...
            from px4.msg import TrajectoryBezier
...
class VehicleTrajectoryBezier(metaclass=Metaclass_VehicleTrajectoryBezier):
    ...
    _fields_and_field_types = {
        'timestamp': 'uint64',
        'control_points': 'px4/TrajectoryBezier[5]',
        'bezier_order': 'uint8',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint64'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['px4', 'msg'], 'TrajectoryBezier'), 5),  # noqa: E501
