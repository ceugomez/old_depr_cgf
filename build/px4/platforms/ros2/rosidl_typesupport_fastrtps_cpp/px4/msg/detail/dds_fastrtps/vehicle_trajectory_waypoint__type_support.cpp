...
#include "px4/msg/detail/vehicle_trajectory_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const px4::msg::TrajectoryWaypoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  px4::msg::TrajectoryWaypoint &);
...
cdr_serialize(
  const px4::msg::VehicleTrajectoryWaypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::VehicleTrajectoryWaypoint & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        px4::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryWaypoint(
...
{
  auto typed_message =
    static_cast<const px4::msg::VehicleTrajectoryWaypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::VehicleTrajectoryWaypoint *>(
    untyped_ros_message);
...
static size_t _VehicleTrajectoryWaypoint__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_VehicleTrajectoryWaypoint(full_bounded, 0);
}
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleTrajectoryWaypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, VehicleTrajectoryWaypoint)() {
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleTrajectoryWaypoint__handle;
}
