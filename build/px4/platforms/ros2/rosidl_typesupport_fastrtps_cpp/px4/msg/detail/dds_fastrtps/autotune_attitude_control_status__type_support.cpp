...
static size_t _AutotuneAttitudeControlStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_AutotuneAttitudeControlStatus(full_bounded, 0);
}
