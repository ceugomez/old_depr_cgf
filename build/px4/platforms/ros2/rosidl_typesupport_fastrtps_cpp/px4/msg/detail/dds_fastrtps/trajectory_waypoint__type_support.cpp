...
#include "px4/msg/detail/trajectory_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::TrajectoryWaypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::TrajectoryWaypoint & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const px4::msg::TrajectoryWaypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::TrajectoryWaypoint *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_TrajectoryWaypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, TrajectoryWaypoint)() {
  return &px4::msg::typesupport_fastrtps_cpp::_TrajectoryWaypoint__handle;
}
