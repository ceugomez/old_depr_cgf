...
#include "px4/msg/detail/vehicle_trajectory_bezier__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const px4::msg::TrajectoryBezier &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  px4::msg::TrajectoryBezier &);
...
cdr_serialize(
  const px4::msg::VehicleTrajectoryBezier & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::VehicleTrajectoryBezier & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: control_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        px4::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryBezier(
...
{
  auto typed_message =
    static_cast<const px4::msg::VehicleTrajectoryBezier *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::VehicleTrajectoryBezier *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleTrajectoryBezier__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, VehicleTrajectoryBezier)() {
  return &px4::msg::typesupport_fastrtps_cpp::_VehicleTrajectoryBezier__handle;
}
