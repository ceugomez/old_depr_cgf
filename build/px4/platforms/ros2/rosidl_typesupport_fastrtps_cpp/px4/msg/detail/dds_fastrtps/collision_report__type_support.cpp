...
#include "px4/msg/detail/collision_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::CollisionReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::CollisionReport & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
{
  auto typed_message =
    static_cast<const px4::msg::CollisionReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::CollisionReport *>(
    untyped_ros_message);
...
static size_t _CollisionReport__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_CollisionReport(full_bounded, 0);
}
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_CollisionReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, CollisionReport)() {
  return &px4::msg::typesupport_fastrtps_cpp::_CollisionReport__handle;
}
