...
#include "px4/msg/detail/event__rosidl_typesupport_fastrtps_c.h"
...
using _Event__ros_msg_type = px4__msg__Event;
...
static uint32_t _Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__Event(
...
{
  return max_serialized_size_px4__msg__Event(
    full_bounded, 0);
}
