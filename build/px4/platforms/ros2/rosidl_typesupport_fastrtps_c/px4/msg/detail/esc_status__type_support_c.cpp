...
#include "px4/msg/detail/esc_status__rosidl_typesupport_fastrtps_c.h"
...
#include "px4/msg/detail/esc_report__functions.h"  // esc

// forward declare type support functions
size_t get_serialized_size_px4__msg__EscReport(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_px4__msg__EscReport(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, EscReport)();


using _EscStatus__ros_msg_type = px4__msg__EscStatus;
  ...
  // Field name: esc
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, px4, msg, EscReport
      )()->data);
    size_t size = 8;
...
size_t get_serialized_size_px4__msg__EscStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EscStatus__ros_msg_type * ros_message = static_cast<const _EscStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name esc
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_px4__msg__EscReport(
...
static uint32_t _EscStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__EscStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__EscStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: esc
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_px4__msg__EscReport(
...
{
  return max_serialized_size_px4__msg__EscStatus(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, EscStatus)() {
