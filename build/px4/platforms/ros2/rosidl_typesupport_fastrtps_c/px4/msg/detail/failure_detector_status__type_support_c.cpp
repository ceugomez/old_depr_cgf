...
#include "px4/msg/detail/failure_detector_status__rosidl_typesupport_fastrtps_c.h"
...
using _FailureDetectorStatus__ros_msg_type = px4__msg__FailureDetectorStatus;
...
size_t get_serialized_size_px4__msg__FailureDetectorStatus(
  const void * untyped_ros_message,
...
static uint32_t _FailureDetectorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__FailureDetectorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__FailureDetectorStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _FailureDetectorStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__FailureDetectorStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, FailureDetectorStatus)() {
