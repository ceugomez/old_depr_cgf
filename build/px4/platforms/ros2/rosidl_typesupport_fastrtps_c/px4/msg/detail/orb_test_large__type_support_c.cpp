...
#include "px4/msg/detail/orb_test_large__rosidl_typesupport_fastrtps_c.h"
...
using _OrbTestLarge__ros_msg_type = px4__msg__OrbTestLarge;
...
static uint32_t _OrbTestLarge__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__OrbTestLarge(
...
{
  return max_serialized_size_px4__msg__OrbTestLarge(
    full_bounded, 0);
}
