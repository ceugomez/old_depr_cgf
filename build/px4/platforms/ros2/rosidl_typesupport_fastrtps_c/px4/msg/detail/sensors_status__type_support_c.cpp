...
#include "px4/msg/detail/sensors_status__rosidl_typesupport_fastrtps_c.h"
...
using _SensorsStatus__ros_msg_type = px4__msg__SensorsStatus;
...
size_t get_serialized_size_px4__msg__SensorsStatus(
  const void * untyped_ros_message,
...
static uint32_t _SensorsStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__SensorsStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__SensorsStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _SensorsStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__SensorsStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, SensorsStatus)() {
