...
#include "px4/msg/detail/gimbal_manager_set_manual_control__rosidl_typesupport_fastrtps_c.h"
...
using _GimbalManagerSetManualControl__ros_msg_type = px4__msg__GimbalManagerSetManualControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GimbalManagerSetManualControl__ros_msg_type * ros_message = static_cast<const _GimbalManagerSetManualControl__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GimbalManagerSetManualControl__ros_msg_type * ros_message = static_cast<_GimbalManagerSetManualControl__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4__msg__GimbalManagerSetManualControl(
  const void * untyped_ros_message,
...
static uint32_t _GimbalManagerSetManualControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__GimbalManagerSetManualControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__GimbalManagerSetManualControl(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _GimbalManagerSetManualControl__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__GimbalManagerSetManualControl(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_GimbalManagerSetManualControl = {
  "px4::msg",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, GimbalManagerSetManualControl)() {
  return &_GimbalManagerSetManualControl__type_support;
}
