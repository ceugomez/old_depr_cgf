...
#include "px4/msg/detail/yaw_estimator_status__rosidl_typesupport_fastrtps_c.h"
...
using _YawEstimatorStatus__ros_msg_type = px4__msg__YawEstimatorStatus;
...
size_t get_serialized_size_px4__msg__YawEstimatorStatus(
  const void * untyped_ros_message,
...
static uint32_t _YawEstimatorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__YawEstimatorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__YawEstimatorStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4__msg__YawEstimatorStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, YawEstimatorStatus)() {
