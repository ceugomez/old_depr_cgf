...
#include "px4/msg/detail/gimbal_device_set_attitude__rosidl_typesupport_fastrtps_c.h"
...
using _GimbalDeviceSetAttitude__ros_msg_type = px4__msg__GimbalDeviceSetAttitude;
...
size_t get_serialized_size_px4__msg__GimbalDeviceSetAttitude(
  const void * untyped_ros_message,
...
static uint32_t _GimbalDeviceSetAttitude__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__GimbalDeviceSetAttitude(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__GimbalDeviceSetAttitude(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4__msg__GimbalDeviceSetAttitude(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, GimbalDeviceSetAttitude)() {
