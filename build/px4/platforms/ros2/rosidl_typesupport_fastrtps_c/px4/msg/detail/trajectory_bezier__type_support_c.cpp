...
#include "px4/msg/detail/trajectory_bezier__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryBezier__ros_msg_type = px4__msg__TrajectoryBezier;
...
static uint32_t _TrajectoryBezier__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__TrajectoryBezier(
...
{
  return max_serialized_size_px4__msg__TrajectoryBezier(
    full_bounded, 0);
}
