...
#include "px4/msg/detail/vehicle_odometry__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleOdometry__ros_msg_type = px4__msg__VehicleOdometry;
  ...
  void * untyped_ros_message)
{
  ...
  _VehicleOdometry__ros_msg_type * ros_message = static_cast<_VehicleOdometry__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4__msg__VehicleOdometry(
  const void * untyped_ros_message,
...
static uint32_t _VehicleOdometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__VehicleOdometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__VehicleOdometry(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _VehicleOdometry__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__VehicleOdometry(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, VehicleOdometry)() {
