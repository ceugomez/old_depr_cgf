  ...
  void * untyped_ros_message)
{
  ...
  _UlogStreamAck__ros_msg_type * ros_message = static_cast<_UlogStreamAck__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
static size_t _UlogStreamAck__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__UlogStreamAck(
    full_bounded, 0);
}
