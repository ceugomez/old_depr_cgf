...
#include "px4/msg/detail/actuator_controls_status__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorControlsStatus__ros_msg_type = px4__msg__ActuatorControlsStatus;
...
size_t get_serialized_size_px4__msg__ActuatorControlsStatus(
  const void * untyped_ros_message,
...
static uint32_t _ActuatorControlsStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__ActuatorControlsStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__ActuatorControlsStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4__msg__ActuatorControlsStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, ActuatorControlsStatus)() {
