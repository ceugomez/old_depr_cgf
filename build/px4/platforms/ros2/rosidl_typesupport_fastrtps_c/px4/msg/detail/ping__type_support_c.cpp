...
#include "px4/msg/detail/ping__rosidl_typesupport_fastrtps_c.h"
...
using _Ping__ros_msg_type = px4__msg__Ping;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Ping__ros_msg_type * ros_message = static_cast<const _Ping__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: ping_sequence
  {
    cdr << ros_message->ping_sequence;
  }

  // Field name: dropped_packets
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Ping__ros_msg_type * ros_message = static_cast<_Ping__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
size_t get_serialized_size_px4__msg__Ping(
  const void * untyped_ros_message,
...
static uint32_t _Ping__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__Ping(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__Ping(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Ping__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__Ping(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Ping = {
  "px4::msg",
  "Ping",
...
static rosidl_message_type_support_t _Ping__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, Ping)() {
  return &_Ping__type_support;
}
