...
#include "px4/msg/detail/uavcan_parameter_request__rosidl_typesupport_fastrtps_c.h"
...
using _UavcanParameterRequest__ros_msg_type = px4__msg__UavcanParameterRequest;
...
size_t get_serialized_size_px4__msg__UavcanParameterRequest(
  const void * untyped_ros_message,
...
static uint32_t _UavcanParameterRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__UavcanParameterRequest(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__UavcanParameterRequest(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _UavcanParameterRequest__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4__msg__UavcanParameterRequest(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, UavcanParameterRequest)() {
