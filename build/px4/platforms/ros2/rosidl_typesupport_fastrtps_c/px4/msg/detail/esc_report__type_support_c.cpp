...
#include "px4/msg/detail/esc_report__rosidl_typesupport_fastrtps_c.h"
...
using _EscReport__ros_msg_type = px4__msg__EscReport;
...
static uint32_t _EscReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__EscReport(
...
{
  return max_serialized_size_px4__msg__EscReport(
    full_bounded, 0);
}
