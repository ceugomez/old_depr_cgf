...
{
  new (message_memory) px4::msg::MavlinkLog(_init);
}

void MavlinkLog_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::MavlinkLog *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MavlinkLog_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::MavlinkLog, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    127,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MavlinkLog, text),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MavlinkLog, severity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MavlinkLog_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, MavlinkLog)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MavlinkLog_message_type_support_handle;
}
