...
{
  new (message_memory) px4::msg::VtolVehicleStatus(_init);
}

void VtolVehicleStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::VtolVehicleStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VtolVehicleStatus_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::VtolVehicleStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VtolVehicleStatus, vehicle_vtol_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VtolVehicleStatus, fixed_wing_system_failure),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VtolVehicleStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(px4::msg::VtolVehicleStatus),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VtolVehicleStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VtolVehicleStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VtolVehicleStatus_message_type_support_handle;
}
