...
{
  new (message_memory) px4::msg::SensorAccelFifo(_init);
}

void SensorAccelFifo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::SensorAccelFifo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorAccelFifo_message_member_array[9] = {
  {
    ...
    offsetof(px4::msg::SensorAccelFifo, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, dt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, scale),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, samples),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, x),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, y),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorAccelFifo, z),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorAccelFifo_message_members = {
  ...
  9,  // number of fields
  sizeof(px4::msg::SensorAccelFifo),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorAccelFifo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, SensorAccelFifo)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorAccelFifo_message_type_support_handle;
}
