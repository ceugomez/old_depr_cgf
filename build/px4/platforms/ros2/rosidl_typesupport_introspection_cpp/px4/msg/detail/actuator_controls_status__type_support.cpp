...
{
  new (message_memory) px4::msg::ActuatorControlsStatus(_init);
}

void ActuatorControlsStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::ActuatorControlsStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActuatorControlsStatus_message_member_array[2] = {
  {
    ...
    offsetof(px4::msg::ActuatorControlsStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ActuatorControlsStatus, control_power),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ActuatorControlsStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(px4::msg::ActuatorControlsStatus),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ActuatorControlsStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, ActuatorControlsStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ActuatorControlsStatus_message_type_support_handle;
}
