...
{
  new (message_memory) px4::msg::ObstacleDistance(_init);
}

void ObstacleDistance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::ObstacleDistance *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleDistance_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::ObstacleDistance, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, frame),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, sensor_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    72,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, distances),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, increment),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, min_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, max_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ObstacleDistance, angle_offset),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleDistance_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::ObstacleDistance),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ObstacleDistance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, ObstacleDistance)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ObstacleDistance_message_type_support_handle;
}
