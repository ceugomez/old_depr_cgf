...
{
  new (message_memory) px4::msg::TrajectoryBezier(_init);
}

void TrajectoryBezier_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::TrajectoryBezier *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryBezier_message_member_array[4] = {
  {
    ...
    offsetof(px4::msg::TrajectoryBezier, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryBezier, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryBezier, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryBezier, delta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryBezier_message_members = {
  ...
  4,  // number of fields
  sizeof(px4::msg::TrajectoryBezier),
...
get_message_type_support_handle<px4::msg::TrajectoryBezier>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectoryBezier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, TrajectoryBezier)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectoryBezier_message_type_support_handle;
}
