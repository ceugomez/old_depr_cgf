...
{
  new (message_memory) px4::msg::ControlAllocatorStatus(_init);
}

void ControlAllocatorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::ControlAllocatorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlAllocatorStatus_message_member_array[7] = {
  {
    ...
    offsetof(px4::msg::ControlAllocatorStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, torque_setpoint_achieved),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, unallocated_torque),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, thrust_setpoint_achieved),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, unallocated_thrust),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    16,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, actuator_saturation),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::ControlAllocatorStatus, handled_motor_failure_mask),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlAllocatorStatus_message_members = {
  ...
  7,  // number of fields
  sizeof(px4::msg::ControlAllocatorStatus),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ControlAllocatorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, ControlAllocatorStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::ControlAllocatorStatus_message_type_support_handle;
}
