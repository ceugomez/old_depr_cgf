...
{
  new (message_memory) px4::msg::EstimatorStates(_init);
}

void EstimatorStates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::EstimatorStates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EstimatorStates_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::EstimatorStates, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorStates, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    24,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorStates, states),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorStates, n_states),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    24,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorStates, covariances),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EstimatorStates_message_members = {
  ...
  5,  // number of fields
  sizeof(px4::msg::EstimatorStates),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::EstimatorStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, EstimatorStates)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::EstimatorStates_message_type_support_handle;
}
