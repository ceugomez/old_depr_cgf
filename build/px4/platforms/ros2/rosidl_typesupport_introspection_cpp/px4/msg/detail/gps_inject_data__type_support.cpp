...
{
  new (message_memory) px4::msg::GpsInjectData(_init);
}

void GpsInjectData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::GpsInjectData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GpsInjectData_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::GpsInjectData, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::GpsInjectData, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::GpsInjectData, len),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::GpsInjectData, flags),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    300,  // array size
    false,  // is upper bound
    offsetof(px4::msg::GpsInjectData, data),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::GpsInjectData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, GpsInjectData)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::GpsInjectData_message_type_support_handle;
}
