...
{
  new (message_memory) px4::msg::VehicleTrajectoryBezier(_init);
}

void VehicleTrajectoryBezier_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::VehicleTrajectoryBezier *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<px4::msg::TrajectoryBezier, 5> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<px4::msg::TrajectoryBezier, 5> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleTrajectoryBezier_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::VehicleTrajectoryBezier, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<px4::msg::TrajectoryBezier>(),  // members of sub message
    true,  // is array
    5,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleTrajectoryBezier, control_points),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleTrajectoryBezier, bezier_order),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleTrajectoryBezier_message_members = {
  ...
  3,  // number of fields
  sizeof(px4::msg::VehicleTrajectoryBezier),
...
get_message_type_support_handle<px4::msg::VehicleTrajectoryBezier>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleTrajectoryBezier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VehicleTrajectoryBezier)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleTrajectoryBezier_message_type_support_handle;
}
