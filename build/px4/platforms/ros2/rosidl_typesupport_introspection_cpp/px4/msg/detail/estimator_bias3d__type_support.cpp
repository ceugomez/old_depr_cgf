...
{
  new (message_memory) px4::msg::EstimatorBias3d(_init);
}

void EstimatorBias3d_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::EstimatorBias3d *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EstimatorBias3d_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::EstimatorBias3d, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, bias),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, bias_var),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, innov),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, innov_var),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::EstimatorBias3d, innov_test_ratio),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EstimatorBias3d_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::EstimatorBias3d),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::EstimatorBias3d_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, EstimatorBias3d)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::EstimatorBias3d_message_type_support_handle;
}
