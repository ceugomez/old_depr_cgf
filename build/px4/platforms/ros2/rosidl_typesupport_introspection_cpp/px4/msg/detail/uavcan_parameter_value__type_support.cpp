...
{
  new (message_memory) px4::msg::UavcanParameterValue(_init);
}

void UavcanParameterValue_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::UavcanParameterValue *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UavcanParameterValue_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::UavcanParameterValue, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, node_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    17,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, param_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, param_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, param_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, param_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, int_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UavcanParameterValue, real_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UavcanParameterValue_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::UavcanParameterValue),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::UavcanParameterValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, UavcanParameterValue)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::UavcanParameterValue_message_type_support_handle;
}
