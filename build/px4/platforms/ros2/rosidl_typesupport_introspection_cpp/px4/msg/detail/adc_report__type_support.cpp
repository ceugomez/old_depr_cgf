...
{
  new (message_memory) px4::msg::AdcReport(_init);
}

void AdcReport_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::AdcReport *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AdcReport_message_member_array[6] = {
  {
    ...
    offsetof(px4::msg::AdcReport, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::AdcReport, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(px4::msg::AdcReport, channel_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(px4::msg::AdcReport, raw_data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::AdcReport, resolution),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::AdcReport, v_ref),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::AdcReport_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, AdcReport)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::AdcReport_message_type_support_handle;
}
