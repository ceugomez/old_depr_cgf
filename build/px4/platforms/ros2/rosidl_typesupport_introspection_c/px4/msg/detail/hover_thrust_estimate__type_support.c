...
void HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_init_function(
...
void HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_fini_function(void * message_memory)
{
  px4__msg__HoverThrustEstimate__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_member_array[9] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_members = {
  "px4__msg",  // message namespace
  "HoverThrustEstimate",  // message name
  9,  // number of fields
  sizeof(px4__msg__HoverThrustEstimate),
  HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_member_array,  // message members
  HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_init_function,  // function to initialize message memory (memory has to be allocated)
  HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, HoverThrustEstimate)() {
  if (!HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_type_support_handle.typesupport_identifier) {
    HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &HoverThrustEstimate__rosidl_typesupport_introspection_c__HoverThrustEstimate_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
