...
#include <stddef.h>
#include "px4/msg/detail/orb_test_medium__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember OrbTestMedium__rosidl_typesupport_introspection_c__OrbTestMedium_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__OrbTestMedium, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__OrbTestMedium, val),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    64,  // array size
    false,  // is upper bound
    offsetof(px4__msg__OrbTestMedium, junk),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers OrbTestMedium__rosidl_typesupport_introspection_c__OrbTestMedium_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__OrbTestMedium),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, OrbTestMedium)() {
