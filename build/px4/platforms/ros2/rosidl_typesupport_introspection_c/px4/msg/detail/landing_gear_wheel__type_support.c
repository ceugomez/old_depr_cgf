...
#include <stddef.h>
#include "px4/msg/detail/landing_gear_wheel__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember LandingGearWheel__rosidl_typesupport_introspection_c__LandingGearWheel_message_member_array[2] = {
  {
    ...
    offsetof(px4__msg__LandingGearWheel, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__LandingGearWheel, normalized_wheel_setpoint),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers LandingGearWheel__rosidl_typesupport_introspection_c__LandingGearWheel_message_members = {
  ...
  2,  // number of fields
  sizeof(px4__msg__LandingGearWheel),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, LandingGearWheel)() {
