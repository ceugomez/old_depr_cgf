...
void HealthReport__rosidl_typesupport_introspection_c__HealthReport_init_function(
...
void HealthReport__rosidl_typesupport_introspection_c__HealthReport_fini_function(void * message_memory)
{
  px4__msg__HealthReport__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_member_array[8] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_members = {
  "px4__msg",  // message namespace
  "HealthReport",  // message name
  8,  // number of fields
  sizeof(px4__msg__HealthReport),
  HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_member_array,  // message members
  HealthReport__rosidl_typesupport_introspection_c__HealthReport_init_function,  // function to initialize message memory (memory has to be allocated)
  HealthReport__rosidl_typesupport_introspection_c__HealthReport_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_type_support_handle = {
  0,
  &HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, HealthReport)() {
  if (!HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_type_support_handle.typesupport_identifier) {
    HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &HealthReport__rosidl_typesupport_introspection_c__HealthReport_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
