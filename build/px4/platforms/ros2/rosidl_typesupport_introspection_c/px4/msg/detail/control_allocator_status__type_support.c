...
#include <stddef.h>
#include "px4/msg/detail/control_allocator_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__ControlAllocatorStatus__init(message_memory);
}
...
{
  px4__msg__ControlAllocatorStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ControlAllocatorStatus__rosidl_typesupport_introspection_c__ControlAllocatorStatus_message_member_array[7] = {
  {
    ...
    offsetof(px4__msg__ControlAllocatorStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, torque_setpoint_achieved),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, unallocated_torque),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, thrust_setpoint_achieved),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, unallocated_thrust),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    16,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, actuator_saturation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ControlAllocatorStatus, handled_motor_failure_mask),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ControlAllocatorStatus__rosidl_typesupport_introspection_c__ControlAllocatorStatus_message_members = {
  ...
  7,  // number of fields
  sizeof(px4__msg__ControlAllocatorStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, ControlAllocatorStatus)() {
