...
#include <stddef.h>
#include "px4/msg/detail/magnetometer_bias_estimate__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__MagnetometerBiasEstimate__init(message_memory);
}
...
{
  px4__msg__MagnetometerBiasEstimate__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MagnetometerBiasEstimate__rosidl_typesupport_introspection_c__MagnetometerBiasEstimate_message_member_array[6] = {
  {
    ...
    offsetof(px4__msg__MagnetometerBiasEstimate, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MagnetometerBiasEstimate, bias_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MagnetometerBiasEstimate, bias_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MagnetometerBiasEstimate, bias_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MagnetometerBiasEstimate, valid),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MagnetometerBiasEstimate, stable),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MagnetometerBiasEstimate__rosidl_typesupport_introspection_c__MagnetometerBiasEstimate_message_members = {
  ...
  6,  // number of fields
  sizeof(px4__msg__MagnetometerBiasEstimate),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, MagnetometerBiasEstimate)() {
