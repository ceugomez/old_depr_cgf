...
#include <stddef.h>
#include "px4/msg/detail/takeoff_status__rosidl_typesupport_introspection_c.h"
...
void TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4__msg__TakeoffStatus__init(message_memory);
}

void TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_fini_function(void * message_memory)
{
  px4__msg__TakeoffStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__TakeoffStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TakeoffStatus, takeoff_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TakeoffStatus, tilt_limit),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__TakeoffStatus),
  TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_message_member_array,  // message members
  TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  TakeoffStatus__rosidl_typesupport_introspection_c__TakeoffStatus_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, TakeoffStatus)() {
