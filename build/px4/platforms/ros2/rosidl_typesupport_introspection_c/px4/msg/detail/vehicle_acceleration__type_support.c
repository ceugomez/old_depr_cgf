...
#include <stddef.h>
#include "px4/msg/detail/vehicle_acceleration__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember VehicleAcceleration__rosidl_typesupport_introspection_c__VehicleAcceleration_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VehicleAcceleration, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleAcceleration, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleAcceleration, xyz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleAcceleration__rosidl_typesupport_introspection_c__VehicleAcceleration_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VehicleAcceleration),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleAcceleration)() {
