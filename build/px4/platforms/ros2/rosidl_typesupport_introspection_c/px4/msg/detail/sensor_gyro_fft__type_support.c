...
void SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_init_function(
...
void SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_fini_function(void * message_memory)
{
  px4__msg__SensorGyroFft__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_member_array[11] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_members = {
  "px4__msg",  // message namespace
  "SensorGyroFft",  // message name
  11,  // number of fields
  sizeof(px4__msg__SensorGyroFft),
  SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_member_array,  // message members
  SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_init_function,  // function to initialize message memory (memory has to be allocated)
  SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_type_support_handle = {
  0,
  &SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, SensorGyroFft)() {
  if (!SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_type_support_handle.typesupport_identifier) {
    SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SensorGyroFft__rosidl_typesupport_introspection_c__SensorGyroFft_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
