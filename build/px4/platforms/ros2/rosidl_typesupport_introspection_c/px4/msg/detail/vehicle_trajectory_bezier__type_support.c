...
#include <stddef.h>
#include "px4/msg/detail/vehicle_trajectory_bezier__rosidl_typesupport_introspection_c.h"
...
#include "px4/msg/trajectory_bezier.h"
// Member `control_points`
#include "px4/msg/detail/trajectory_bezier__rosidl_typesupport_introspection_c.h"
...
void VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4__msg__VehicleTrajectoryBezier__init(message_memory);
}

void VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_fini_function(void * message_memory)
{
  px4__msg__VehicleTrajectoryBezier__fini(message_memory);
}
...
{
  const px4__msg__TrajectoryBezier ** member =
    (const px4__msg__TrajectoryBezier **)(untyped_member);
  return &(*member)[index];
}
...
{
  px4__msg__TrajectoryBezier ** member =
    (px4__msg__TrajectoryBezier **)(untyped_member);
  return &(*member)[index];
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VehicleTrajectoryBezier, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTrajectoryBezier, control_points),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTrajectoryBezier, bezier_order),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VehicleTrajectoryBezier),
  ...
  VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleTrajectoryBezier)() {
  VehicleTrajectoryBezier__rosidl_typesupport_introspection_c__VehicleTrajectoryBezier_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, TrajectoryBezier)();
