...
#include <stddef.h>
#include "px4/msg/detail/vehicle_optical_flow_vel__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__VehicleOpticalFlowVel__init(message_memory);
}

void VehicleOpticalFlowVel__rosidl_typesupport_introspection_c__VehicleOpticalFlowVel_fini_function(void * message_memory)
{
  px4__msg__VehicleOpticalFlowVel__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VehicleOpticalFlowVel__rosidl_typesupport_introspection_c__VehicleOpticalFlowVel_message_member_array[11] = {
  {
    "timestamp",  // name
    ...
    offsetof(px4__msg__VehicleOpticalFlowVel, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, vel_body),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, vel_ne),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, flow_uncompensated_integral),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, flow_compensated_integral),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, gyro_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, gyro_rate_integral),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, gyro_bias),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, ref_gyro),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleOpticalFlowVel, meas_gyro),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleOpticalFlowVel__rosidl_typesupport_introspection_c__VehicleOpticalFlowVel_message_members = {
  ...
  11,  // number of fields
  sizeof(px4__msg__VehicleOpticalFlowVel),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleOpticalFlowVel)() {
