...
#include <stddef.h>
#include "px4/msg/detail/power_button_state__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember PowerButtonState__rosidl_typesupport_introspection_c__PowerButtonState_message_member_array[2] = {
  {
    ...
    offsetof(px4__msg__PowerButtonState, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__PowerButtonState, event),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PowerButtonState__rosidl_typesupport_introspection_c__PowerButtonState_message_members = {
  ...
  2,  // number of fields
  sizeof(px4__msg__PowerButtonState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, PowerButtonState)() {
