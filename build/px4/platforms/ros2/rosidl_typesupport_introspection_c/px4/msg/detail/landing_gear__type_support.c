...
#include <stddef.h>
#include "px4/msg/detail/landing_gear__rosidl_typesupport_introspection_c.h"
...
void LandingGear__rosidl_typesupport_introspection_c__LandingGear_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4__msg__LandingGear__init(message_memory);
}

void LandingGear__rosidl_typesupport_introspection_c__LandingGear_fini_function(void * message_memory)
{
  px4__msg__LandingGear__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember LandingGear__rosidl_typesupport_introspection_c__LandingGear_message_member_array[2] = {
  {
    ...
    offsetof(px4__msg__LandingGear, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__LandingGear, landing_gear),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers LandingGear__rosidl_typesupport_introspection_c__LandingGear_message_members = {
  ...
  2,  // number of fields
  sizeof(px4__msg__LandingGear),
  LandingGear__rosidl_typesupport_introspection_c__LandingGear_message_member_array,  // message members
  LandingGear__rosidl_typesupport_introspection_c__LandingGear_init_function,  // function to initialize message memory (memory has to be allocated)
  LandingGear__rosidl_typesupport_introspection_c__LandingGear_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, LandingGear)() {
