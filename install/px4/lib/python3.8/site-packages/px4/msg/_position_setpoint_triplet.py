    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4.msg.PositionSetpointTriplet')
            logger.debug(
            ...
            from px4.msg import PositionSetpoint
...
class PositionSetpointTriplet(metaclass=Metaclass_PositionSetpointTriplet):
    ...
    _fields_and_field_types = {
        'timestamp': 'uint64',
        'previous': 'px4/PositionSetpoint',
        'current': 'px4/PositionSetpoint',
        'next': 'px4/PositionSetpoint',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint64'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['px4', 'msg'], 'PositionSetpoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['px4', 'msg'], 'PositionSetpoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['px4', 'msg'], 'PositionSetpoint'),  # noqa: E501
    )
