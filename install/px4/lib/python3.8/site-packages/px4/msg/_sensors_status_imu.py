        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'accel_inconsistency_m_s_s' field must be a set or sequence with length 4 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'gyro_inconsistency_rad_s' field must be a set or sequence with length 4 and each value of type 'float'"
