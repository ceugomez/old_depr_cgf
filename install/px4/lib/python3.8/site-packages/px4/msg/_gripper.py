...
class Metaclass_Gripper(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'COMMAND_GRAB': cls.__constants['COMMAND_GRAB'],
            'COMMAND_RELEASE': cls.__constants['COMMAND_RELEASE'],
        }

    @property
    def COMMAND_GRAB(self):
        """Message constant 'COMMAND_GRAB'."""
        return Metaclass_Gripper.__constants['COMMAND_GRAB']

    @property
    def COMMAND_RELEASE(self):
        """Message constant 'COMMAND_RELEASE'."""
        return Metaclass_Gripper.__constants['COMMAND_RELEASE']
