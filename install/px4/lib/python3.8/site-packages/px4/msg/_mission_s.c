...
bool px4__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._mission.Mission", full_classname_dest, 24) == 0);
  }
  px4__msg__Mission * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // safe_points_update_counter
    ...
    assert(PyLong_Check(field));
    ros_message->safe_points_update_counter = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * px4__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._mission");
  ...
  {  // safe_points_update_counter
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->safe_points_update_counter);
    {
