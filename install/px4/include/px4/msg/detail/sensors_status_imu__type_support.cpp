...
{
  new (message_memory) px4::msg::SensorsStatusImu(_init);
}

void SensorsStatusImu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::SensorsStatusImu *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorsStatusImu_message_member_array[11] = {
  {
    ...
    offsetof(px4::msg::SensorsStatusImu, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, accel_device_id_primary),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, accel_device_ids),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, accel_inconsistency_m_s_s),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, accel_healthy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, accel_priority),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, gyro_device_id_primary),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, gyro_device_ids),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, gyro_inconsistency_rad_s),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, gyro_healthy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorsStatusImu, gyro_priority),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorsStatusImu_message_members = {
  ...
  11,  // number of fields
  sizeof(px4::msg::SensorsStatusImu),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorsStatusImu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, SensorsStatusImu)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorsStatusImu_message_type_support_handle;
}
