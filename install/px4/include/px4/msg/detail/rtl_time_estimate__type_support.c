...
#include <stddef.h>
#include "px4/msg/detail/rtl_time_estimate__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember RtlTimeEstimate__rosidl_typesupport_introspection_c__RtlTimeEstimate_message_member_array[4] = {
  {
    ...
    offsetof(px4__msg__RtlTimeEstimate, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__RtlTimeEstimate, valid),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__RtlTimeEstimate, time_estimate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__RtlTimeEstimate, safe_time_estimate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RtlTimeEstimate__rosidl_typesupport_introspection_c__RtlTimeEstimate_message_members = {
  ...
  4,  // number of fields
  sizeof(px4__msg__RtlTimeEstimate),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, RtlTimeEstimate)() {
