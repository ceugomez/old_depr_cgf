...
void DebugVect_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) px4::msg::DebugVect(_init);
}

void DebugVect_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::DebugVect *>(message_memory);
  typed_message->~DebugVect();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugVect_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::DebugVect, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    10,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DebugVect, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DebugVect, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DebugVect, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DebugVect, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DebugVect_message_members = {
  ...
  5,  // number of fields
  sizeof(px4::msg::DebugVect),
  DebugVect_message_member_array,  // message members
  DebugVect_init_function,  // function to initialize message memory (memory has to be allocated)
  DebugVect_fini_function  // function to terminate message instance (will not free memory)
};
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::DebugVect_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, DebugVect)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::DebugVect_message_type_support_handle;
}
