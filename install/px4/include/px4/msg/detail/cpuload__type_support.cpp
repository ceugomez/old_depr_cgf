...
{
  new (message_memory) px4::msg::Cpuload(_init);
}

void Cpuload_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::Cpuload *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Cpuload_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::Cpuload, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::Cpuload, load),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::Cpuload, ram_usage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::Cpuload_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, Cpuload)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::Cpuload_message_type_support_handle;
}
