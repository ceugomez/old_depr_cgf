...
{
  new (message_memory) px4::msg::MagnetometerBiasEstimate(_init);
}

void MagnetometerBiasEstimate_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::MagnetometerBiasEstimate *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MagnetometerBiasEstimate_message_member_array[6] = {
  {
    ...
    offsetof(px4::msg::MagnetometerBiasEstimate, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MagnetometerBiasEstimate, bias_x),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MagnetometerBiasEstimate, bias_y),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MagnetometerBiasEstimate, bias_z),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MagnetometerBiasEstimate, valid),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MagnetometerBiasEstimate, stable),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MagnetometerBiasEstimate_message_members = {
  ...
  6,  // number of fields
  sizeof(px4::msg::MagnetometerBiasEstimate),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MagnetometerBiasEstimate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, MagnetometerBiasEstimate)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MagnetometerBiasEstimate_message_type_support_handle;
}
