...
#include <stddef.h>
#include "px4/msg/detail/tiltrotor_extra_controls__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__TiltrotorExtraControls__init(message_memory);
}
...
{
  px4__msg__TiltrotorExtraControls__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember TiltrotorExtraControls__rosidl_typesupport_introspection_c__TiltrotorExtraControls_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__TiltrotorExtraControls, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TiltrotorExtraControls, collective_tilt_normalized_setpoint),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TiltrotorExtraControls, collective_thrust_normalized_setpoint),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TiltrotorExtraControls__rosidl_typesupport_introspection_c__TiltrotorExtraControls_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__TiltrotorExtraControls),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, TiltrotorExtraControls)() {
