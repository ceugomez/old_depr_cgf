...
void Airspeed__rosidl_typesupport_introspection_c__Airspeed_init_function(
...
void Airspeed__rosidl_typesupport_introspection_c__Airspeed_fini_function(void * message_memory)
{
  px4__msg__Airspeed__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_member_array[6] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__Airspeed, air_temperature_celsius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Airspeed__rosidl_typesupport_introspection_c__Airspeed_message_members = {
  ...
  Airspeed__rosidl_typesupport_introspection_c__Airspeed_init_function,  // function to initialize message memory (memory has to be allocated)
  Airspeed__rosidl_typesupport_introspection_c__Airspeed_fini_function  // function to terminate message instance (will not free memory)
};
