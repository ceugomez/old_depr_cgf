...
{
  new (message_memory) px4::msg::TrajectoryWaypoint(_init);
}

void TrajectoryWaypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::TrajectoryWaypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryWaypoint_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::TrajectoryWaypoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, acceleration),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, yaw_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, point_valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::TrajectoryWaypoint, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryWaypoint_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::TrajectoryWaypoint),
...
get_message_type_support_handle<px4::msg::TrajectoryWaypoint>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectoryWaypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, TrajectoryWaypoint)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::TrajectoryWaypoint_message_type_support_handle;
}
