...
#include <stddef.h>
#include "px4/msg/detail/geofence_result__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember GeofenceResult__rosidl_typesupport_introspection_c__GeofenceResult_message_member_array[5] = {
  {
    ...
    offsetof(px4__msg__GeofenceResult, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GeofenceResult, geofence_violation_reason),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GeofenceResult, primary_geofence_breached),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GeofenceResult, primary_geofence_action),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GeofenceResult, home_required),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GeofenceResult__rosidl_typesupport_introspection_c__GeofenceResult_message_members = {
  ...
  5,  // number of fields
  sizeof(px4__msg__GeofenceResult),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, GeofenceResult)() {
