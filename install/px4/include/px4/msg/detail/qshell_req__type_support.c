...
#include <stddef.h>
#include "px4/msg/detail/qshell_req__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember QshellReq__rosidl_typesupport_introspection_c__QshellReq_message_member_array[4] = {
  {
    ...
    offsetof(px4__msg__QshellReq, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    100,  // array size
    false,  // is upper bound
    offsetof(px4__msg__QshellReq, cmd),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__QshellReq, strlen),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__QshellReq, request_sequence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, QshellReq)() {
