...
#include <stddef.h>
#include "px4/msg/detail/timesync_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__TimesyncStatus__init(message_memory);
}

void TimesyncStatus__rosidl_typesupport_introspection_c__TimesyncStatus_fini_function(void * message_memory)
{
  px4__msg__TimesyncStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TimesyncStatus__rosidl_typesupport_introspection_c__TimesyncStatus_message_member_array[6] = {
  {
    "timestamp",  // name
    ...
    offsetof(px4__msg__TimesyncStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TimesyncStatus, source_protocol),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TimesyncStatus, remote_timestamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TimesyncStatus, observed_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TimesyncStatus, estimated_offset),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TimesyncStatus, round_trip_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TimesyncStatus__rosidl_typesupport_introspection_c__TimesyncStatus_message_members = {
  ...
  6,  // number of fields
  sizeof(px4__msg__TimesyncStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, TimesyncStatus)() {
