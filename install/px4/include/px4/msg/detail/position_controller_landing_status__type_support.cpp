...
{
  new (message_memory) px4::msg::PositionControllerLandingStatus(_init);
}

void PositionControllerLandingStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::PositionControllerLandingStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PositionControllerLandingStatus_message_member_array[4] = {
  {
    ...
    offsetof(px4::msg::PositionControllerLandingStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::PositionControllerLandingStatus, lateral_touchdown_offset),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::PositionControllerLandingStatus, flaring),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::PositionControllerLandingStatus, abort_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PositionControllerLandingStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(px4::msg::PositionControllerLandingStatus),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::PositionControllerLandingStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, PositionControllerLandingStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::PositionControllerLandingStatus_message_type_support_handle;
}
