...
#include <stddef.h>
#include "px4/msg/detail/mavlink_log__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember MavlinkLog__rosidl_typesupport_introspection_c__MavlinkLog_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__MavlinkLog, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    127,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MavlinkLog, text),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__MavlinkLog, severity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, MavlinkLog)() {
