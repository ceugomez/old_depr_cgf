...
{
public:
  explicit Init_Airspeed_air_temperature_celsius(::px4::msg::Airspeed & msg)
  : msg_(msg)
  {}
  Init_Airspeed_confidence air_temperature_celsius(::px4::msg::Airspeed::_air_temperature_celsius_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Airspeed_air_temperature_celsius true_airspeed_m_s(::px4::msg::Airspeed::_true_airspeed_m_s_type arg)
  {
