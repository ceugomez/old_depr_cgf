...
#include <stddef.h>
#include "px4/msg/detail/orb_test_large__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember OrbTestLarge__rosidl_typesupport_introspection_c__OrbTestLarge_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__OrbTestLarge, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__OrbTestLarge, val),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    512,  // array size
    false,  // is upper bound
    offsetof(px4__msg__OrbTestLarge, junk),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, OrbTestLarge)() {
