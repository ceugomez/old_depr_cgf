...
#include <stddef.h>
#include "px4/msg/detail/vehicle_trajectory_waypoint__rosidl_typesupport_introspection_c.h"
...
// Member `waypoints`
#include "px4/msg/trajectory_waypoint.h"
// Member `waypoints`
#include "px4/msg/detail/trajectory_waypoint__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__VehicleTrajectoryWaypoint__init(message_memory);
}
...
{
  px4__msg__VehicleTrajectoryWaypoint__fini(message_memory);
}
...
{
  const px4__msg__TrajectoryWaypoint ** member =
    (const px4__msg__TrajectoryWaypoint **)(untyped_member);
  return &(*member)[index];
}
...
{
  px4__msg__TrajectoryWaypoint ** member =
    (px4__msg__TrajectoryWaypoint **)(untyped_member);
  return &(*member)[index];
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleTrajectoryWaypoint__rosidl_typesupport_introspection_c__VehicleTrajectoryWaypoint_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VehicleTrajectoryWaypoint, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTrajectoryWaypoint, type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTrajectoryWaypoint, waypoints),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleTrajectoryWaypoint__rosidl_typesupport_introspection_c__VehicleTrajectoryWaypoint_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VehicleTrajectoryWaypoint),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleTrajectoryWaypoint)() {
  VehicleTrajectoryWaypoint__rosidl_typesupport_introspection_c__VehicleTrajectoryWaypoint_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, TrajectoryWaypoint)();
