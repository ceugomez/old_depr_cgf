...
{
  new (message_memory) px4::msg::QshellReq(_init);
}

void QshellReq_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::QshellReq *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember QshellReq_message_member_array[4] = {
  {
    ...
    offsetof(px4::msg::QshellReq, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    100,  // array size
    false,  // is upper bound
    offsetof(px4::msg::QshellReq, cmd),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::QshellReq, strlen),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::QshellReq, request_sequence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::QshellReq_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, QshellReq)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::QshellReq_message_type_support_handle;
}
