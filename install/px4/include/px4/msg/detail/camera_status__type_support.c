...
#include <stddef.h>
#include "px4/msg/detail/camera_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  px4__msg__CameraStatus__init(message_memory);
}

void CameraStatus__rosidl_typesupport_introspection_c__CameraStatus_fini_function(void * message_memory)
{
  px4__msg__CameraStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CameraStatus__rosidl_typesupport_introspection_c__CameraStatus_message_member_array[3] = {
  {
    "timestamp",  // name
    ...
    offsetof(px4__msg__CameraStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__CameraStatus, active_sys_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__CameraStatus, active_comp_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, CameraStatus)() {
