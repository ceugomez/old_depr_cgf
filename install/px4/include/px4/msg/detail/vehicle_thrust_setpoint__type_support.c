...
#include <stddef.h>
#include "px4/msg/detail/vehicle_thrust_setpoint__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember VehicleThrustSetpoint__rosidl_typesupport_introspection_c__VehicleThrustSetpoint_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VehicleThrustSetpoint, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleThrustSetpoint, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleThrustSetpoint, xyz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleThrustSetpoint__rosidl_typesupport_introspection_c__VehicleThrustSetpoint_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VehicleThrustSetpoint),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleThrustSetpoint)() {
