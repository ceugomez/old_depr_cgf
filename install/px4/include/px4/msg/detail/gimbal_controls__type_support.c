...
#include <stddef.h>
#include "px4/msg/detail/gimbal_controls__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember GimbalControls__rosidl_typesupport_introspection_c__GimbalControls_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__GimbalControls, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GimbalControls, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__GimbalControls, control),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GimbalControls__rosidl_typesupport_introspection_c__GimbalControls_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__GimbalControls),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, GimbalControls)() {
