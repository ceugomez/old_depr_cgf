...
px4__msg__QshellReq__create()
{
  ...
  px4__msg__QshellReq * msg = (px4__msg__QshellReq *)allocator.allocate(sizeof(px4__msg__QshellReq), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__QshellReq));
  bool success = px4__msg__QshellReq__init(msg);
  if (!success) {
...
px4__msg__QshellReq__Sequence__init(px4__msg__QshellReq__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__QshellReq * data = NULL;

  if (size) {
    data = (px4__msg__QshellReq *)allocator.zero_allocate(size, sizeof(px4__msg__QshellReq), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__QshellReq__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__QshellReq__fini(&data[i - 1]);
      }
...
px4__msg__QshellReq__Sequence__fini(px4__msg__QshellReq__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__QshellReq__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__QshellReq__Sequence * array = (px4__msg__QshellReq__Sequence *)allocator.allocate(sizeof(px4__msg__QshellReq__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__QshellReq__Sequence__init(array, size);
  if (!success) {
...
px4__msg__QshellReq__Sequence__destroy(px4__msg__QshellReq__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__QshellReq__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
px4__msg__QshellReq__Sequence__are_equal(const px4__msg__QshellReq__Sequence * lhs, const px4__msg__QshellReq__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__QshellReq__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4__msg__QshellReq__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__QshellReq);
    px4__msg__QshellReq * data =
      (px4__msg__QshellReq *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__QshellReq__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4__msg__QshellReq__fini(&data[i]);
        }
        free(data);
        return false;
      }
