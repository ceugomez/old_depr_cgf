...
#include <stddef.h>
#include "px4/msg/detail/vehicle_torque_setpoint__rosidl_typesupport_introspection_c.h"
...
void VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4__msg__VehicleTorqueSetpoint__init(message_memory);
}

void VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_fini_function(void * message_memory)
{
  px4__msg__VehicleTorqueSetpoint__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VehicleTorqueSetpoint, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTorqueSetpoint, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VehicleTorqueSetpoint, xyz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VehicleTorqueSetpoint),
  VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_message_member_array,  // message members
  VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleTorqueSetpoint__rosidl_typesupport_introspection_c__VehicleTorqueSetpoint_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VehicleTorqueSetpoint)() {
