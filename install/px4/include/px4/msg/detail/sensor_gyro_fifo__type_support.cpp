...
{
  new (message_memory) px4::msg::SensorGyroFifo(_init);
}

void SensorGyroFifo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::SensorGyroFifo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorGyroFifo_message_member_array[9] = {
  {
    ...
    offsetof(px4::msg::SensorGyroFifo, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, dt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, scale),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, samples),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, x),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, y),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::SensorGyroFifo, z),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorGyroFifo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, SensorGyroFifo)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::SensorGyroFifo_message_type_support_handle;
}
