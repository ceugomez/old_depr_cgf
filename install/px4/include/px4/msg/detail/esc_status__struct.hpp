...
#ifndef PX4__MSG__DETAIL__ESC_STATUS__STRUCT_HPP_
#define PX4__MSG__DETAIL__ESC_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__EscStatus __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__EscStatus __declspec(deprecated)
#endif
...
struct EscStatus_
{
  ...
  explicit EscStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->esc.fill(px4::msg::EscReport_<ContainerAllocator>{_init});
    }
  }
  ...
  : esc(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->esc_online_flags = 0;
      this->esc_armed_flags = 0;
      this->esc.fill(px4::msg::EscReport_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _esc_type =
    std::array<px4::msg::EscReport_<ContainerAllocator>, 8>;
  _esc_type esc;
  ...
  Type & set__esc(
    const std::array<px4::msg::EscReport_<ContainerAllocator>, 8> & _arg)
  {
    this->esc = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    px4::msg::EscStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::EscStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::EscStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::EscStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::EscStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::EscStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::EscStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::EscStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::EscStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__EscStatus
    std::shared_ptr<px4::msg::EscStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__EscStatus
    std::shared_ptr<px4::msg::EscStatus_<ContainerAllocator> const>
...
using EscStatus =
  px4::msg::EscStatus_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__ESC_STATUS__STRUCT_HPP_
