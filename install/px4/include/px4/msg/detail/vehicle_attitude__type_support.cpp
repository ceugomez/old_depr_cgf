...
{
  new (message_memory) px4::msg::VehicleAttitude(_init);
}

void VehicleAttitude_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::VehicleAttitude *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleAttitude_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::VehicleAttitude, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitude, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitude, q),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitude, delta_q_reset),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleAttitude, quat_reset_counter),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleAttitude_message_members = {
  ...
  5,  // number of fields
  sizeof(px4::msg::VehicleAttitude),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleAttitude_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VehicleAttitude)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleAttitude_message_type_support_handle;
}
