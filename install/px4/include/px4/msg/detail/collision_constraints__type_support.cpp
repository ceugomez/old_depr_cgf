...
{
  new (message_memory) px4::msg::CollisionConstraints(_init);
}

void CollisionConstraints_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::CollisionConstraints *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CollisionConstraints_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::CollisionConstraints, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::CollisionConstraints, original_setpoint),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::CollisionConstraints, adapted_setpoint),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CollisionConstraints_message_members = {
  ...
  3,  // number of fields
  sizeof(px4::msg::CollisionConstraints),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::CollisionConstraints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, CollisionConstraints)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::CollisionConstraints_message_type_support_handle;
}
