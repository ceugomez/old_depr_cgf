...
{
  new (message_memory) px4::msg::OrbTestLarge(_init);
}

void OrbTestLarge_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::OrbTestLarge *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OrbTestLarge_message_member_array[3] = {
  {
    ...
    offsetof(px4::msg::OrbTestLarge, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::OrbTestLarge, val),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    512,  // array size
    false,  // is upper bound
    offsetof(px4::msg::OrbTestLarge, junk),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::OrbTestLarge_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, OrbTestLarge)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::OrbTestLarge_message_type_support_handle;
}
