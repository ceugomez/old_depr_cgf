...
#ifndef PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
#define PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__VehicleTrajectoryBezier __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__VehicleTrajectoryBezier __declspec(deprecated)
#endif
...
struct VehicleTrajectoryBezier_
{
  ...
  explicit VehicleTrajectoryBezier_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      this->timestamp = 0ull;
      this->control_points.fill(px4::msg::TrajectoryBezier_<ContainerAllocator>{_init});
      this->bezier_order = 0;
    }
  }
  ...
  : control_points(_alloc)
  {
    ...
    {
      this->timestamp = 0ull;
      this->control_points.fill(px4::msg::TrajectoryBezier_<ContainerAllocator>{_alloc, _init});
      this->bezier_order = 0;
    }
  }
  ...
  using _control_points_type =
    std::array<px4::msg::TrajectoryBezier_<ContainerAllocator>, 5>;
  ...
  Type & set__control_points(
    const std::array<px4::msg::TrajectoryBezier_<ContainerAllocator>, 5> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::VehicleTrajectoryBezier_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__VehicleTrajectoryBezier
    std::shared_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__VehicleTrajectoryBezier
    std::shared_ptr<px4::msg::VehicleTrajectoryBezier_<ContainerAllocator> const>
...
using VehicleTrajectoryBezier =
  px4::msg::VehicleTrajectoryBezier_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__VEHICLE_TRAJECTORY_BEZIER__STRUCT_HPP_
