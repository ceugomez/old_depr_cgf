...
{
  new (message_memory) px4::msg::YawEstimatorStatus(_init);
}

void YawEstimatorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::YawEstimatorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember YawEstimatorStatus_message_member_array[9] = {
  {
    ...
    offsetof(px4::msg::YawEstimatorStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, yaw_composite),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, yaw_variance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, yaw_composite_valid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, yaw),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, innov_vn),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, innov_ve),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    5,  // array size
    false,  // is upper bound
    offsetof(px4::msg::YawEstimatorStatus, weight),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers YawEstimatorStatus_message_members = {
  ...
  9,  // number of fields
  sizeof(px4::msg::YawEstimatorStatus),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::YawEstimatorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, YawEstimatorStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::YawEstimatorStatus_message_type_support_handle;
}
