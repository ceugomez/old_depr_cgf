...
#ifndef PX4__MSG__DETAIL__VEHICLE_OPTICAL_FLOW_VEL__STRUCT_HPP_
#define PX4__MSG__DETAIL__VEHICLE_OPTICAL_FLOW_VEL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__VehicleOpticalFlowVel __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__VehicleOpticalFlowVel __declspec(deprecated)
#endif
...
struct VehicleOpticalFlowVel_
{
  ...
  explicit VehicleOpticalFlowVel_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<float, 3>::iterator, float>(this->meas_gyro.begin(), this->meas_gyro.end(), 0.0f);
    }
  }
  ...
  using _meas_gyro_type =
    std::array<float, 3>;
  _meas_gyro_type meas_gyro;
  ...
  // pointer types
  using RawPtr =
    px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::VehicleOpticalFlowVel_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__VehicleOpticalFlowVel
    std::shared_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__VehicleOpticalFlowVel
    std::shared_ptr<px4::msg::VehicleOpticalFlowVel_<ContainerAllocator> const>
  ...
  bool operator==(const VehicleOpticalFlowVel_ & other) const
  {
    ...
    if (this->meas_gyro != other.meas_gyro) {
      return false;
    }
    return true;
  }
...
using VehicleOpticalFlowVel =
  px4::msg::VehicleOpticalFlowVel_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__VEHICLE_OPTICAL_FLOW_VEL__STRUCT_HPP_
