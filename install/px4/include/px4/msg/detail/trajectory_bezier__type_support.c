...
static rosidl_typesupport_introspection_c__MessageMember TrajectoryBezier__rosidl_typesupport_introspection_c__TrajectoryBezier_message_member_array[4] = {
  {
    ...
    offsetof(px4__msg__TrajectoryBezier, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TrajectoryBezier, position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TrajectoryBezier, yaw),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__TrajectoryBezier, delta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryBezier__rosidl_typesupport_introspection_c__TrajectoryBezier_message_members = {
  ...
  4,  // number of fields
  sizeof(px4__msg__TrajectoryBezier),
