...
{
  new (message_memory) px4::msg::VehicleOpticalFlowVel(_init);
}

void VehicleOpticalFlowVel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::VehicleOpticalFlowVel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleOpticalFlowVel_message_member_array[11] = {
  {
    ...
    offsetof(px4::msg::VehicleOpticalFlowVel, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, timestamp_sample),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, vel_body),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, vel_ne),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, flow_uncompensated_integral),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, flow_compensated_integral),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, gyro_rate),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, gyro_rate_integral),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, gyro_bias),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, ref_gyro),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(px4::msg::VehicleOpticalFlowVel, meas_gyro),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleOpticalFlowVel_message_members = {
  ...
  11,  // number of fields
  sizeof(px4::msg::VehicleOpticalFlowVel),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleOpticalFlowVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VehicleOpticalFlowVel)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::VehicleOpticalFlowVel_message_type_support_handle;
}
