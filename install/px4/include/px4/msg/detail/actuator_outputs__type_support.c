...
#include <stddef.h>
#include "px4/msg/detail/actuator_outputs__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ActuatorOutputs__rosidl_typesupport_introspection_c__ActuatorOutputs_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__ActuatorOutputs, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ActuatorOutputs, noutputs),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    16,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ActuatorOutputs, output),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ActuatorOutputs__rosidl_typesupport_introspection_c__ActuatorOutputs_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__ActuatorOutputs),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, ActuatorOutputs)() {
