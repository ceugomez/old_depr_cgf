...
#include <stddef.h>
#include "px4/msg/detail/vtol_vehicle_status__rosidl_typesupport_introspection_c.h"
...
void VtolVehicleStatus__rosidl_typesupport_introspection_c__VtolVehicleStatus_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  px4__msg__VtolVehicleStatus__init(message_memory);
}

void VtolVehicleStatus__rosidl_typesupport_introspection_c__VtolVehicleStatus_fini_function(void * message_memory)
{
  px4__msg__VtolVehicleStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember VtolVehicleStatus__rosidl_typesupport_introspection_c__VtolVehicleStatus_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__VtolVehicleStatus, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VtolVehicleStatus, vehicle_vtol_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__VtolVehicleStatus, fixed_wing_system_failure),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VtolVehicleStatus__rosidl_typesupport_introspection_c__VtolVehicleStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__VtolVehicleStatus),
  ...
  VtolVehicleStatus__rosidl_typesupport_introspection_c__VtolVehicleStatus_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, VtolVehicleStatus)() {
