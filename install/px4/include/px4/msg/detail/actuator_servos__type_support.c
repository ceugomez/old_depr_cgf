...
#include <stddef.h>
#include "px4/msg/detail/actuator_servos__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ActuatorServos__rosidl_typesupport_introspection_c__ActuatorServos_message_member_array[3] = {
  {
    ...
    offsetof(px4__msg__ActuatorServos, timestamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ActuatorServos, timestamp_sample),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(px4__msg__ActuatorServos, control),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ActuatorServos__rosidl_typesupport_introspection_c__ActuatorServos_message_members = {
  ...
  3,  // number of fields
  sizeof(px4__msg__ActuatorServos),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, ActuatorServos)() {
