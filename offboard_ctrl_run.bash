...
gnome-terminal -- /bin/sh -c 'cd $PWD/src/PX4-Autopilot/;  make px4_sitl gazebo-classic_iris_rplidar' 
#launch middleware & listener simultaneously [change listener to custom action TBD]
(trap 'kill 0' SIGINT; MicroXRCEAgent udp4 -p 8888 & ros2 launch px4_offboard offboard_position_control.launch.py) 
